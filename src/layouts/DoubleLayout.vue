...
.layout {
  &__double-sidebar {
    ...
    box-shadow: 1px 0 2px rgb(17 24 39 / 3%);
  ...
  &__primary-item {
    ...
    &.is-active {
      ...
      background-color: color-mix(in srgb, var(--el-color-primary) 11%, transparent);
    }
    ...
    &:focus-visible {
      outline: none;
      box-shadow: 0 0 0 2px color-mix(in srgb, var(--el-color-primary) 32%, transparent);
    }
  }
